...
namespace Nature_Gallery_Final_Project.Controllers
{
    ...
    //Publiher controller used by adminuser only
    ...
    public class PublishersController : Controller
    {
        ...
        public PublishersController(Nature_Gallery_DataContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmailAddresss,PublisherName")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
